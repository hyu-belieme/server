...
-- insert history
insert into history(id, item_id, num, requester_id, reserved_time_stamp, approve_manager_id, approve_time_stamp, return_manager_id, return_time_stamp, lost_manager_id, lost_time_stamp, cancel_manager_id, cancel_time_stamp)
values (1, 1, 1, 1, 1673155356, 1, 1673155430, 1, 1673159244, null, 0, null, 0);
update item set last_history_id=1, next_history_num=2 where id=1;

insert into history(id, item_id, num, requester_id, reserved_time_stamp, approve_manager_id, approve_time_stamp, return_manager_id, return_time_stamp, lost_manager_id, lost_time_stamp, cancel_manager_id, cancel_time_stamp)
values (2, 6, 1, 1, 1673155356, null, 0, null, 0, null, 0, null, 0);
update item set last_history_id=2, next_history_num=2 where id=6;

insert into history(id, item_id, num, requester_id, reserved_time_stamp, approve_manager_id, approve_time_stamp, return_manager_id, return_time_stamp, lost_manager_id, lost_time_stamp, cancel_manager_id, cancel_time_stamp)
values (3, 1, 2, 2, 1673172221, 1, 1673172521, null, 0, null, 0, null, 0);
update item set last_history_id=3, next_history_num=3 where id=1;

insert into history(id, item_id, num, requester_id, reserved_time_stamp, approve_manager_id, approve_time_stamp, return_manager_id, return_time_stamp, lost_manager_id, lost_time_stamp, cancel_manager_id, cancel_time_stamp)
values (4, 17, 1, 1, 1673172221, null, 0, null, 0, null, 0, 1, 1673172521);
update item set last_history_id=4, next_history_num=2 where id=17;