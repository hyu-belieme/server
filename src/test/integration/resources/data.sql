...
-- insert major
insert into MAJOR_(id, university_id, code)values ('edbbfebc63b446e1975367451d3614f8', '37364342434533424143344334433445', 'FH04067');
insert into MAJOR_(id, university_id, code)values ('b9624786b93f422ebb1183c6c2f6cbd8', '37364342434533424143344334433445', 'FH04068');
insert into MAJOR_(id, university_id, code)values ('ebfba44eb632467298e8e6aeb8fcca8c', '37364342434533424143344334433445', 'FH04069');
insert into MAJOR_(id, university_id, code)values ('422c2f41f0fa42569c59178c68c6172c', '41463146463944354244463734353333', 'A68');
insert into MAJOR_(id, university_id, code)values ('272dc52d346b417991c6e894b2ff2b63', '41463146463944354244463734353333', 'A69');
insert into MAJOR_(id, university_id, code)values ('40044cd4f5e54a78855c4f4f52c92799', '41463146463944354244463734353333', 'A70');
...
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (1, 'edbbfebc63b446e1975367451d3614f8', 'c7312fe706264068911251a1b8e04309');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (2, 'b9624786b93f422ebb1183c6c2f6cbd8', 'c7312fe706264068911251a1b8e04309');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (3, 'ebfba44eb632467298e8e6aeb8fcca8c', 'b069fa11c416427696e1aaad27f73aeb');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (4, 'edbbfebc63b446e1975367451d3614f8', '9ebea9d296694560990c3628ddc29d23');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (5, 'b9624786b93f422ebb1183c6c2f6cbd8', '9ebea9d296694560990c3628ddc29d23');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (6, 'ebfba44eb632467298e8e6aeb8fcca8c', '9ebea9d296694560990c3628ddc29d23');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (7, '272dc52d346b417991c6e894b2ff2b63', 'fd16b1f820ff47ef9a7d46e5d1e1c080');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (8, '422c2f41f0fa42569c59178c68c6172c', '65fd918548b6407b8bca8177b4d64713');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (9, '272dc52d346b417991c6e894b2ff2b63', '65fd918548b6407b8bca8177b4d64713');
insert MAJOR_DEPARTMENT_JOIN_(id, major_id, department_id)values (10, '40044cd4f5e54a78855c4f4f52c92799', '65fd918548b6407b8bca8177b4d64713');
...
-- insert new user
insert into USER_(id, university_id, student_id, name, entrance_year, token, created_at, approved_at)
...
-- insert stuff
insert into STUFF_(id, department_id, name, thumbnail)values ('5f35946da596466c94d30a09431a6309', 'c7312fe706264068911251a1b8e04309', '블루투스 스피커', '📻');
insert into STUFF_(id, department_id, name, thumbnail)values ('b1b566baef964bff9883abb62aec7245', 'c7312fe706264068911251a1b8e04309', '우산', '🌂');
insert into STUFF_(id, department_id, name, thumbnail)values ('02143755e80c472b9a231f9624364846', 'c7312fe706264068911251a1b8e04309', '볼펜', '🖋️');
insert into STUFF_(id, department_id, name, thumbnail)values ('ec5de918030f40beb0603ddb415e358e', 'c7312fe706264068911251a1b8e04309', '가위', '✂️');
insert into STUFF_(id, department_id, name, thumbnail)values ('a6aee430b84247c6a6efc7410869b4a7', 'c7312fe706264068911251a1b8e04309', '스케이트보드', '🛹');

insert into STUFF_(id, department_id, name, thumbnail)values ('d540534434f64b84beaf24f6506a4fc7', 'b069fa11c416427696e1aaad27f73aeb', '우산', '🌂');
insert into STUFF_(id, department_id, name, thumbnail)values ('13801bd5b74a43bbb32b323c3c59f9f2', 'b069fa11c416427696e1aaad27f73aeb', '가위', '✂️');
insert into STUFF_(id, department_id, name, thumbnail)values ('fe54a40127a64561b749ad392024185a', 'b069fa11c416427696e1aaad27f73aeb', '망치', '🔨');

insert into STUFF_(id, department_id, name, thumbnail)values ('a731bba0f5ee49cea8309e5ae1727dad', '9ebea9d296694560990c3628ddc29d23', '우산', '🌂');
insert into STUFF_(id, department_id, name, thumbnail)values ('6223fa3673674099b0d89bbfff04c755', '9ebea9d296694560990c3628ddc29d23', '볼펜', '🖋️');
insert into STUFF_(id, department_id, name, thumbnail)values ('cda0319e0e8541c98da733ccf04b4311', '9ebea9d296694560990c3628ddc29d23', '가위', '✂️');
insert into STUFF_(id, department_id, name, thumbnail)values ('9ada08c580004ed8a0882486b25d8cf2', '9ebea9d296694560990c3628ddc29d23', '계산기', '🧮️');

insert into STUFF_(id, department_id, name, thumbnail)values ('89a9e2c16102475db1a8ce237c0b0223', 'fd16b1f820ff47ef9a7d46e5d1e1c080', '볼펜', '🖋️');
insert into STUFF_(id, department_id, name, thumbnail)values ('0613bdfd71a046ee910d51e9b058efee', 'fd16b1f820ff47ef9a7d46e5d1e1c080', '가위', '✂');
insert into STUFF_(id, department_id, name, thumbnail)values ('eebb33783d044ba9a1cc297d2d0ab156', 'fd16b1f820ff47ef9a7d46e5d1e1c080', '축구공', '⚽');

-- insert item
insert into ITEM_(id, stuff_id, num, last_history_id)values ('91fe5765d8da4590bb5f0cc9325a0f99', '5f35946da596466c94d30a09431a6309', 1, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('781007d9ac1f440aa2a8faffcd366b9a', '5f35946da596466c94d30a09431a6309', 2, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('979acb01ea6f47c7a32f9faaa5bc6fd2', 'b1b566baef964bff9883abb62aec7245', 1, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('e9bcb3df40a14132b6d357814fb42b9b', 'b1b566baef964bff9883abb62aec7245', 2, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('dee510ec87b2483cbdbb26798464f1f7', 'b1b566baef964bff9883abb62aec7245', 3, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('8977e997e60a432196160da5d2e92169', 'b1b566baef964bff9883abb62aec7245', 4, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('daf5957960294450a635f5fb8a2ff7f9', '02143755e80c472b9a231f9624364846', 1, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('573c1eef52674b1e9f18c5539425ad52', '02143755e80c472b9a231f9624364846', 2, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('13b0d597f45c4c2990eb583b5ae81f45', '02143755e80c472b9a231f9624364846', 3, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('d0c3732d6c624398b43de59b421314ce', '02143755e80c472b9a231f9624364846', 4, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('ee7c67cea9ce475f83c8040423c36586', '02143755e80c472b9a231f9624364846', 5, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('b1c9e3c9dc2f4deda7ff4923d34f55fd', '02143755e80c472b9a231f9624364846', 6, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('a97821c229c74434992b5ceb9f6d7ca0', 'ec5de918030f40beb0603ddb415e358e', 1, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('57a88c8d446f4d858cad7bb9df81f5e7', 'ec5de918030f40beb0603ddb415e358e', 2, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('59b46b319e3544f6b9a64a8970481438', 'ec5de918030f40beb0603ddb415e358e', 3, null);
insert into ITEM_(id, stuff_id, num, last_history_id)values ('fde3b0bff1b4452986df844af597244a', 'a6aee430b84247c6a6efc7410869b4a7', 1, null);

-- insert history
insert into HISTORY_(id, item_id, num, requester_id, approve_manager_id, return_manager_id, lost_manager_id, cancel_manager_id, requested_at, approved_at, returned_at, lost_at, canceled_at)
