...
public abstract class BaseDaoImpl {
    ...
    protected AuthorityEntity findAuthorityEntity(String universityName, String departmentName, String permission) {
    ...
    protected StuffEntity findStuffEntity(String universityName, String departmentName, String stuffName) {
        UUID departmentId = findDepartmentEntity(universityName, departmentName).getId();
    ...
    protected ItemEntity findItemEntity(String universityName, String departmentName, String stuffName, int itemNum) {
    ...
    protected HistoryEntity findHistoryEntity(String universityName, String departmentName, String stuffName, int itemNum, int historyNum) {
