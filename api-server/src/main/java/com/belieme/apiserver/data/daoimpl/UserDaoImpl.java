...
public class UserDaoImpl extends BaseDaoImpl implements UserDao {
  ...
  @Override
  public UserDto create(@NonNull UUID userId, @NonNull UUID universityId, @NonNull String studentId,
    ...
    UserEntity newUserEntity = saveUserOnly(userId, universityId, studentId, name, entranceYear,
        token, createdAt, approvedAt);
  ...
  @Override
  public UserDto update(@NonNull UUID userId, @NonNull UUID universityId, @NonNull String studentId,
      @NonNull String name, int entranceYear, @NonNull String token, long createdAt,
      long approvedAt, @NonNull List<AuthorityDto> authorities) {
    UserEntity target = findUserEntity(userId);
    target = updateUserOnly(target, universityId, studentId, name, entranceYear, token, createdAt,
        approvedAt);
  ...
  private UserEntity saveUserOnly(UUID userId, UUID universityId, String studentId, String name,
      int entranceYear, String token, long createdAt, long approvedAt) {
    UniversityEntity universityEntity = getUniversityEntityOrThrowInvalidIndexException(
        universityId);
  ...
  private UserEntity updateUserOnly(UserEntity target, UUID universityId, String studentId,
      String name, int entranceYear, String token, long createdAt, long approvedAt) {
