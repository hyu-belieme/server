...
public record DepartmentDto(@NonNull UUID id, @NonNull UniversityDto university,
                            @NonNull String name, @NonNull List<MajorDto> baseMajors) {

  private static final UUID NIL_UUID = UUID.fromString("00000000-0000-0000-0000-000000000000");
  public static final DepartmentDto nestedEndpoint = new DepartmentDto(NIL_UUID,
      UniversityDto.nestedEndpoint, "-", new ArrayList<>());

  public DepartmentDto(@NonNull UUID id, @NonNull UniversityDto university, @NonNull String name,
      @NonNull List<MajorDto> baseMajors) {
    this.id = id;
  ...
  public static DepartmentDto init(@NonNull UniversityDto university, @NonNull String name,
      @NonNull List<MajorDto> baseMajors) {
  ...
  public String toString() {
    ...
    return "DepartmentDto{" + "id='" + id + '\'' + ", university=" + university + ", name='" + name
