...
public record ItemDto(@NonNull UUID id, @NonNull StuffDto stuff, int num, HistoryDto lastHistory) {

  private static final UUID NIL_UUID = UUID.fromString("00000000-0000-0000-0000-000000000000");
  public static final ItemDto nestedEndpoint = new ItemDto(NIL_UUID, StuffDto.nestedEndpoint, 0,
      null);
  ...
  public String toString() {
    ...
    return "ItemDto{" + "id=" + id + ", stuff=" + stuff + ", num=" + num + ", lastHistory="
        + lastHistory + '}';
  }
}