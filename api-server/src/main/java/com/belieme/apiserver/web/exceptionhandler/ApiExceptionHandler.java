...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    protected ResponseEntity<Object> handleExceptionInternal(Exception e, @Nullable Object body, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        e.printStackTrace();
        if (body == null) {
    ...
    private ExceptionResponse makeResponse(ErrorInfo errorInfo, List<ExceptionResponse.ValidationError> validationErrors) {
        return new ExceptionResponse(
                errorInfo.name(),
                getMessageFromSource(errorInfo.responseMessage()),
                validationErrors
