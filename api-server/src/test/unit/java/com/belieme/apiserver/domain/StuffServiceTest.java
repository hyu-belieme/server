...
public class StuffServiceTest extends BaseServiceTest {
  ...
  public final class TestGetListByDepartment extends StuffNestedTest {
    ...
    public void SUCCESS() {
      ...
      when(stuffDao.getListByDepartment(deptId)).thenReturn(stuffList);

      TestHelper.listCompareTest(this::execMethod, stuffList);
    }
    ...
    private List<StuffDto> getStuffListByDept(DepartmentDto dept) {
      return stub.ALL_STUFFS.stream().filter((stuff) -> dept.matchId(stuff.department()))
  ...
  public final class TestUpdate extends StuffNestedTest {
    ...
    public void SUCCESS_allMemberIsNotNull() {
      setUpDefault();
      StuffDto expected = targetStuff.withName(newStuffName).withThumbnail(newStuffThumbnail);
    ...
    public void SUCCESS_someMemberIsNull() {
      setUpDefault();
      newStuffName = null;
      StuffDto expected = targetStuff.withThumbnail(newStuffThumbnail);
