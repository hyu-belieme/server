...
public class UniversityDaoTest extends BaseDaoTest {
  ...
  public class TestUpdate {
    ...
    private UniversityEntity savedUniv() {
      return targetUniv.withName(newUnivDto.name()).withApiUrl(newUnivDto.apiUrl());
    }
    ...
    public void SUCCESS_notChangeIndex() {
      ...
      newUnivDto = targetUniv.toUniversityDto().withApiUrl("https://NewApiUrl.com");
    ...
    public void SUCCESS_changeIndex() {
      setTargetUniv(randomUniv());
      newUnivDto = targetUniv.toUniversityDto().withName("__NEW_NAME")
    ...
    public void SUCCESS_notSameIdOnNewUniversity() {
      setTargetUniv(randomUniv());
      newUnivDto = randomUniv().toUniversityDto().withName("__NEW_NAME")
          .withApiUrl("https://NewApiUrl.com");
