...
public class EntityStubData extends BaseEntityStub {
  ...
  public EntityStubData() {
    ...
    StuffEntity SPEAKER_HYU_CSE = new StuffEntity(
        UUID.fromString("5f35946d-a596-466c-94d3-0a09431a6309"), HYU_CSE_DEPT, "블루투스 스피커", "📻");
    ...
    StuffEntity PEN_HYU_CSE = new StuffEntity(
        UUID.fromString("02143755-e80c-472b-9a23-1f9624364846"), HYU_CSE_DEPT, "볼펜", "🖋️");
    ...
    StuffEntity UMBRELLA_HYU_ME = new StuffEntity(
        UUID.fromString("d5405344-34f6-4b84-beaf-24f6506a4fc7"), HYU_ME_DEPT, "우산", "🌂");
    StuffEntity SCISSORS_HYU_ME = new StuffEntity(
        UUID.fromString("13801bd5-b74a-43bb-b32b-323c3c59f9f2"), HYU_ME_DEPT, "가위", "✂️");
    StuffEntity HAMMER_HYU_ME = new StuffEntity(
        UUID.fromString("fe54a401-27a6-4561-b749-ad392024185a"), HYU_ME_DEPT, "망치", "🔨");
    ...
    StuffEntity PEN_HYU_ENG = new StuffEntity(
        UUID.fromString("6223fa36-7367-4099-b0d8-9bbfff04c755"), HYU_ENG_DEPT, "볼펜", "🖋️");
    ...
    StuffEntity PEN_CKU_MED = new StuffEntity(
        UUID.fromString("89a9e2c1-6102-475d-b1a8-ce237c0b0223"), CKU_MED_DEPT, "볼펜", "🖋️");
