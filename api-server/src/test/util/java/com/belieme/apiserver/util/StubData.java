...
public class StubData extends BaseStub {
  ...
  public StubData() {
    ...
    HYU_CSE_DEPT = new DepartmentDto(UUID.fromString("c7312fe7-0626-4068-9112-51a1b8e04309"),
        HYU_UNIV, "컴퓨터소프트웨어학부", new ArrayList<>())
    ...
    tmpAllUsers = List.of(
        DEV_1_USER, DEV_2_USER, DEV_3_USER, HYU_CSE_TESTER_1_USER, HYU_ME_TESTER_1_USER,
        HYU_CSE_MASTER_USER,
